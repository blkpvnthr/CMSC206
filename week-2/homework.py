...
if __name__ == "__main__":
    ...
    # Test foo functions
    test_string = "Emma is a good developer. Emma works hard. Emma likes coding."
    substring = "Emma"
    print(f"Occurrences of '{substring}': {foo(test_string, substring)}")
    occurrences, indices = foo_enhanced(test_string, substring)
    print(f"Occurrences: {occurrences}, Indices: {indices}")
